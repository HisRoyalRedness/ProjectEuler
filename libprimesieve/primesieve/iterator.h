...
__declspec(dllexport) void primesieve_init(primesieve_iterator* it);

/** Free all memory */
__declspec(dllexport) void primesieve_free_iterator(primesieve_iterator* it);
 ...
 */
__declspec(dllexport) void primesieve_skipto(primesieve_iterator* it, uint64_t start, uint64_t stop_hint);
...
/** Get the next prime */
__declspec(dllexport) uint64_t primesieve_next_prime(primesieve_iterator* it);
